$(document).ready(function () {
    ...
    if ($('.member-item').length === 0) {
        ...
        const tableType = document.getElementById('inputSearchType');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let patient of patients) {
                    ...
                    td1.innerHTML = String(patient.name);
                    tr.appendChild(td1);

                    let td2 = document.createElement('td');
                    td2.innerHTML = String(patient.email);
                    tr.appendChild(td2);

                    let td3 = document.createElement('td');
                    td3.innerHTML = String(patient.contact_number);
                    tr.appendChild(td3);
