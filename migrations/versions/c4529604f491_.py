...
def upgrade():
    ...
    with op.batch_alter_table('vitals', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_vitals_patient_id'), ['patient_id'], unique=False)

    op.create_table('working_hours',
    sa.Column('doctor_id', sa.String(length=128), nullable=False),
    sa.Column('start_time', sa.Time(), nullable=False),
    sa.Column('end_time', sa.Time(), nullable=False),
    sa.Column('day', sa.Enum('SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', name='dayofweek'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.CheckConstraint('end_time > start_time', name='check_time_validity'),
    ...
    with op.batch_alter_table('working_hours', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_working_hours_doctor_id'), ['doctor_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_working_hours_end_time'), ['end_time'], unique=False)
        batch_op.create_index(batch_op.f('ix_working_hours_start_time'), ['start_time'], unique=False)
